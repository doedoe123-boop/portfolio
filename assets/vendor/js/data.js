...
const portfolioData = {
  ...
  projects: [
    {
      id: 'personal-blog',
      title: 'Personal Blog',
      description: 'A static blog built with Hugo showcasing my web development journey, technical insights, and learning experiences.',
      status: 'live',
      statusClass: 'live',
    ...
    },
    {
      ...
      description: 'A comprehensive fitness tracking application with health tips, workout plans, and progress monitoring features.',
      status: 'Live',
      statusClass: 'live',
    ...
    },
    {
      id: 'planify',
      title: 'Planify',
      description: 'A modern SaaS platform that streamlines the quotation process for businesses. Generate professional quotes, manage clients, and handle proposals efficiently.',
  ...
  skills: {
    categories: [
      ...
      },
      {
        ...
        items: ['Laravel', 'Node.js', 'PHPMailer', 'Hugo', 'React / React Native', 'Vue.js']
      },
      {
        title: 'Cloud & Server Management',
        items: ['AWS', 'DigitalOcean (DO)', 'Google Cloud Platform (GCP)', 'Ubuntu/Debian Server', 'NGINX', 'Vercel']
      },
      {
  ...
  testimonials: [
    {
      content: 'I highly recommend Nelson as an exceptional web developer and teammate. He\'s always reliable whenever I need assistance or have questions and consistently showcases his deep understanding of web development.',
      author: {
    ...
    {
      content: 'We\'ve worked on several projects, both local and international, and Nelson consistently meets client expectations. His passion for development and continuous learning makes him a valuable asset to any team.',
      author: {
        name: 'Alexis B.',
    ...
    {
      content: 'Nelson is a talented web developer who\'s great to work with. He knows his stuff when it comes to modern web technologies and always gets the job done efficiently.',
      author: {
        name: 'Veronica G.',
